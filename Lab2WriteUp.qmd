...
The resulting class of the vector above is numeric. This is because when we construct a vector with multiple types of data in `R`, `R` will always identify the class of the last entry and apply it to all of the data stored in that vector.