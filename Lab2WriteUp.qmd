...
## Part 2.b
We can create a vector of the first 10 Triangular Numbers (beginning with $F_1$) by creating a vector for the numbers 1 through 10, and then applying the formula provided:
